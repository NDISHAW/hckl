...
const Header = () => {
  ...
  return (
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 backdrop-blur drop-shadow-lg bg-opacity-100">
      <header className={'fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 backdrop-blur drop-shadow-lg bg-opacity-100'}></header>
