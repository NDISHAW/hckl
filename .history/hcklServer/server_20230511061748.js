    ...
    html: `<table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          ...
          <th style="border: 3px solid #ccc; padding: 8px;">Image</th>
            <th style="border:3px solid #ccc; padding: 8px;">Title</th>
            <th style="border: 3px solid #ccc; padding: 8px;">Price</th>
            <th style="border: 3px solid #ccc; padding: 8px;">Quantity</th>
          </tr>
        </thead>
        <tbody>
          ${cartItems
            ...
            <img src=${item.imageURL} alt="Product Image" style="width: 40%; max-width: 100%;">
          </td>
