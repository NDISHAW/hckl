...
app.post("/send-email", (req, res) => {
  ...
  const msg = {
    ...
    //           <img src=${item.imageURL} alt="Product Image" style="width: 50%; max-width: 100%;">
    //         </td>
    //                 <td style="border: 1px solid #2B89D0; padding: 10px;">${item.title}</td>
    //           <td style="border: 1px solid #2B89D0; padding: 30px;"><strong>KSH   ${item.price}</strong></td>

    //                 <td style="border: 1px solid #2B89D0; padding: 10px;">${item.qty}</td>
    //               </tr>
    //             `
    //           )
    //           .join("")}
...
body {font-family: 'Poppins', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:10px 0px 0px 0px; line-height:16px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 10px">P.O BOX 11038-00100 Nairobi Kenya</span></div>
<div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 10px">Tele FAX: +254 (0)20 206 7969</span></div>
<div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 10px">E-mail: info@hckl.co.keg</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="600" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://hckl.co.ke/wp-content/uploads/2018/06/logo-web-1.png" height="189">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:30px 0px 40px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 12px"><strong>THANK YOU FOR SHOPPING WITH US TODAY.</strong></span></div>
...
<div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 12px">January 20, 2020 5:40 PM</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 40px 40px 40px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="color: #80817f; font-size: 12px"><strong>Employee:</strong></span><span style="color: #80817f; font-size: 12px"> Sammie</span></div>
<div style="font-family: inherit; text-align: inherit"><span style="color: #80817f; font-size: 12px"><strong>Customer:</strong></span><span style="color: #80817f; font-size: 12px"> Jane Doe</span></div>
<div style="font-family: inherit; text-align: inherit"><span style="color: #80817f; font-size: 12px"><strong>Email:</strong></span><span style="color: #80817f; font-size: 12px"> janedoe@example.com</span></div>
<div style="font-family: inherit; text-align: inherit"><span style="color: #80817f; font-size: 12px"><strong>Ticket Number: </strong></span><span style="color: #80817f; font-size: 12px">123456789</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 12px"><strong>PRICE</strong></span></div>
        <div></div></div></td>
      </tr>
    </tbody>
  </table></td>
    ...
    <tbody>
      <tr>
        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 12px">$175.90</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
    ...
    <tbody>
      <tr>
        <td style="padding:15px 0px 15px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 12px">$35.90</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
    ...
    <tbody>
      <tr>
        <td style="padding:10px 0px 20px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #80817f; font-size: 12px"><strong>Want to check out all our products? We now offer free shipping!</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:40px 30px 40px 30px; line-height:22px; text-align:inherit; background-color:#80817f;" height="100%" valign="top" bgcolor="#80817f" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 12px"><strong>Thank you for shopping at Beauvais + Lille. If you need to return any items, they need to be returned in its original packaging with proof of purchase. If you do not have a proof of purchase, we can offer you store credit.</strong></span></div>
<div style="font-family: inherit; text-align: center"><br></div>
<div style="font-family: inherit; text-align: center"><span style="color: #ffffff; font-size: 12px"><strong>We hope you enjoy our products!</strong></span></div><div></div></div></td>
      </tr>
    </tbody>
