  ...
  const msg = {
    ...
    html: `<table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          ...
          <tr>
          <th style="border: 8px solid #ccc; padding: 8px;">Image</th>
            <th style="border:38px solid #ccc; padding: 80px;">Title</th>
            <th style="border: 3px solid #ccc; padding: 80px;">Price</th>
            <th style="border: 3px solid #ccc; padding: 80px;">Quantity</th>
          </tr>
        </thead>
        <tbody>
          ${cartItems
            ...
            <img src=${item.imageURL} alt="Product Image" style="width: 40%; max-width: 40%;">
          </td>
          ...
          <tr>
            ...
            <td style="border: 8px solid #ccc; padding: 30px;"><strong>KSH   ${tot}</strong></td>
          </tr>
        </tbody>
      </table>`,
  };
