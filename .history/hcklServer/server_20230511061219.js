...
app.post("/send-email", (req, res) => {
  ...
  const msg = {
    ...
    html: `<table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          <td colspan="3">
            <img src="https://hckl.co.ke/wp-content/uploads/2018/06/logo-web-1.png" alt="Header Image" style="width: 100%; max-width: screec; items-justify: center;">
          </td>
        </tr>
          <tr>
          <th style="border: 1px solid #ccc; padding: 1px;">Image</th>
