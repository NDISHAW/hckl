...
app.post("/send-email", (req, res) => {
  ...
  const msg = {
    ...
    html: `<table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          <td colspan="3">
            <img src="https://hckl.co.ke/wp-content/uploads/2018/06/logo-web-1.png" alt="Header Image" style="width: 100%; max-width: 600px;">
          </td>
        </tr>
          <tr>
          <th style="border: 1px solid #ccc; padding: 10px;">I</th>
          ...
          ${cartItems
            .map(
              (item) => `
                <tr>
                <td colspan="3">
            <img src=${item.imageURL} alt="Product Image" style="width: flex; max-width: flex;">
          </td>
            ...
            .join("")}
          <tr>
            <td colspan="2" style="text-align: right; border: 1px solid #ccc; padding: 10px;"><strong>Total price:</strong></td>
