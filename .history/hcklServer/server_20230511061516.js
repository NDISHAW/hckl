    ...
    html: `<table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          ...
          <th style="border: 8px solid #ccc; padding: 8px;">Image</th>
            <th style="border: 8px solid #ccc; padding: 80px;">Title</th>
            <th style="border: 8px solid #ccc; padding: 80px;">Price</th>
            <th style="border: 8px solid #ccc; padding: 80px;">Quantity</th>
          </tr>
        </thead>
        <tbody>
          ${cartItems
