                                  ...
                                  <tr>
                                    <td style="padding:30px 0px 40px 0px; line-height:22px; text-align:inherit;"
                                      ...
                                      <div>
                                        ...
                                        <div style="font-family: inherit; text-align: center"><span
                                            style="color: #80817f; font-size: 12px">${time.now}</span>
                                        </div>
                                        <div></div>
                                      </div>
                                    </td>
                                    ...
                                    <td style="padding:0px 40px 40px 40px; line-height:22px; text-align:inherit;"
                                      ...
                                      <div>
                                        ...
                                        <div style="font-family: inherit; text-align: inherit"><span
                                            ...
                                            style="color: #80817f; font-size: 12px"> ${toEmail}</span></div>
                                        <div style="font-family: inherit; text-align: inherit"><span
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td
                                                      ...
                                                      <div>
                                                        <div style="font-family: inherit; text-align: center"><span
                                                            style="color: #80817f; font-size: 12px">${item.title}</span></div>
                                                        <div></div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td
                                                      ...
                                                      <div>
                                                        <div style="font-family: inherit; text-align: center"><span
                                                            style="color: #80817f; font-size: 12px">${item.qty}</span></div>
                                                        <div></div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td
                                                      ...
                                                      <div>
                                                        <div style="font-family: inherit; text-align: center"><span
                                                            style="color: #80817f; font-size: 12px">${item.price}</span></div>
                                                        <div></div>
                                                      </div>
                                                    </td>
                                                  </tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td style="padding:10px 0px 20px 0px; line-height:22px; text-align:inherit;"
                                      ...
                                      <div>
                                        <div style="font-family: inherit; text-align: center"><span
                                            style="color: #80817f; font-size: 12px"><strong>Some products may not include their price, in that case we will contact you for further information!</strong></span></div>
                                        <div></div>
                                      </div>
                                    </td>
                                  </tr>
                                          ...
                                          <tr>
                                            <td align="center" bgcolor="#ffecea" class="inner-td"
                                              ...
                                              <a href="HCKL.CO.KE"
                                                ...
                                                target="_blank">Continue shoping Online</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                      ...
                                      <div>
                                        <div style="font-family: inherit; text-align: center"><span
                                            style="color: #ffffff; font-size: 12px"><strong>Thank you for shopping at
                                              HCKL. If you need to return any items, they need to be
                              ...
                              <!-- <div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe"
                                ...
                                <div class="Unsubscribe--addressLine">
                                  ...
                                  <p style="font-size:12px; line-height:20px;"><span
                                      ...
                                      class="Unsubscribe--senderZip">${}</span></p>
                                </div> -->
                                          ...
                                          <tr>
                                            <td align="center" bgcolor="#f5f8fd" class="inner-td"
                                              ...
                                              <a href="https://sendgrid.com/"
                                                ...
                                                target="_blank">♥ ALL RIGHTS RECEIVED @2023 HCKL.CO.KE</a>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
