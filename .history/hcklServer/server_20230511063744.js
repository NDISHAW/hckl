        ...
        <tbody>
          ${cartItems
            ...
            <img src=${item.imageURL} alt="Product Image" style="width: 50%; max-width: 100%;">
                  ...
                  <td style="border: 1px solid #2B89D0; padding: 10px;">${item.price}</td>
                  <td  style="text-align: center; border: 3px solid #2B89D0; padding: 20px;"><strong>Total price:</strong></td>
            <td style="border: 8px solid #2B89D0; padding: 30px;"><strong>KSH   ${item.price}</strong></td>
