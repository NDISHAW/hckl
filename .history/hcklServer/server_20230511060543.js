...
app.post("/send-email", (req, res) => {
  ...
  const msg = {
    ...
    html: `<table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          <td colspan="3">
            <img src="https://hckl.co.ke/wp-content/uploads/2018/06/logo-web-1.png" alt="Header Image" style="width: 100%; max-width: 600px; items-justify: center;">
          </td>
        </tr>
          <tr>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="border: 8px solid #ccc; padding: 10px;"><strong>KSH =//  ${tot}</strong></td>
          </tr>
        </tbody>
      </table>`,
  };
