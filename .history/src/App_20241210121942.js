...
import LabRa from "./components/EmailOrderForm";
import CartContainer from "./components/Cart/CartContainer";
import MyComponent from "./components/Manage/LabReagents/test";
import FirestoreComponent from "./components/Manage/LabReagents/test";
import ReagentComponent from "./components/Manage/LabReagents/test";
  ...
  return (
    <AnimatePresence exitBeforeEnter>
      ...
      {/* <div className="w-auto h-auto flex flex-col bg-primary scrollbar-hide"> */}
        <Header /> <br />
        <main className="mt- md:mt-2 max-h-screen px-4 md:px-16 py-4 w-full scrollbar-hide">
          <Routes>
