    ...
    <Section className="w-full my-8 ">
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-3a75 h-[375px] min-w-[275px] md:w-300 md:min-w-[300px]  bg-cardOverlay rounded-lg py-2 px-4  my-12 backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative">
