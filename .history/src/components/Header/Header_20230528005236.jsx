        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <button
              type="button"
              onClick={SignIn}
              className="bg-gradient-to-br bg-blue-300 hover:bg-green-600 w-full md:w-auto px-4 py-  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
            >
              <svg
