...
const Sidenav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 right-0 w-[35vw]md:w-175 h-flex  bg-cardOverlay  py-8 px-4  my-20 rounded-lg p-10 pl-5 text-textColor fixed   ease-in-out duration-300 ${
          showSidenav ? "translate-x-40 opacity-100 " : "translate-x-full"
        }`}
