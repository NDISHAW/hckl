    ...
    >
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between fill-white">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <p
              className="relative   rounded-full hover:bg-green-500 hover:text-textColor-blue-500-blue-500 text-xl cursor-pointer outline-none hover:shadow-md  duration-500 transition-all ease-in-out"
              onClick={logout}
            >
              <MdLogin /> LOG IN
            </p>
