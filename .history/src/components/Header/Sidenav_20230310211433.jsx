...
const Sidenav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 right-0 w-[125vw] md:w-175 h-flex  bg-white  py-8 px-4  my-20 rounded-lg p-10 pl-5 text-blue-900 fixed backdrop-blur-md drop-shadow-2xl font-bold ease-in-out duration-300 ${
