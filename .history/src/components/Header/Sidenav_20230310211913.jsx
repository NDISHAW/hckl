  ...
  return (
    <>
      ...
      >
        ...
        >
          <Link to={"/"} className="flex items-center gap-2 top-10">
            <li className="text-xl text-blue-900 hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer gap-2 top-10">
              Home
            </li>
          </Link>
          <Link to={"/about"}>
