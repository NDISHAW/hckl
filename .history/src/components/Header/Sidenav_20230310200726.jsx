...
const Sidenav = () => {
  ...
  return (
    <>
      ...
      <div className="h-screen w-screen bg-zinc-50 text-center">
        <div className="absolute top-0 left-0 right-0 bottom-0 h-full w-full overflow-hidden bg-fixed py-12 text-center">
          <button
            id="toggler"
            className="m-12 inline-block rounded bg-blue-600 px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg"
          ...
          <div>
            <img
              className="inline-block w-5/6 rounded"
