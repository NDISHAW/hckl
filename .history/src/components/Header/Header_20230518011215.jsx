...
const Header = () => {
  ...
  const [const [openAddModal, setOpenAddModal] = useState(false);, const [openAddModal, setOpenAddModal] = useState(false);] = useState(false);
  openLogInModal;
  setOpenLogInModal;
  ...
  return (
    ...
    >
      ...
      {openLogInModal && (
        <SignIn onClose={() => setOpenLogInModal(false)} open={openLogInModal} />
      )}
      {openAddModal && (
