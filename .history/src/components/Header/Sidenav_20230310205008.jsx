...
const Sidenav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 right-0 w-[35vw]md:w-175 h-flex  bg-Main backdrop-blur-md py-5 px-4  my-12 rounded-lg p-10 pl-5 text-textColor fixed   ease-in-out duration-300 ${
