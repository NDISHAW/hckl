      ...
      <Modal modalLable="Log In" onClose={onClose} open={open}>
        <div className="max-w-[700px] mx-auto my-16 p-4">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button className="border border-blue-500 bg-blue-600 hover:bg-blue-500 w-full p-4 my- text-white text-xl" onClick={loginWithPopup}>
              {/* Google Sign In */}
              <FcGoogle className="w-auto font-bold text-2xl h-full" /> Sign in with your Google Account
            </button>
          </form>
        </div>
      </Modal>
