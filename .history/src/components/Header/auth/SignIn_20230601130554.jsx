      ...
      <Modal modalLable="Log In" onClose={onClose} open={open}>
        <div className="max-w-[700px] mx-auto ">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button className="border border-blue-500 bg-blue-600 hover:bg-blue-400 w-full p-4 my- text-white text-xl" onClick={loginWithPopup}>
              {/* Google Sign In */}
              <FcGoogle className="w-full font-bold text-2xl h-20" /> Sign in with your Google Account
            </button>
          </form>
        </div>
      </Modal>
