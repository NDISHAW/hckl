...
const SignIn = ({ onClose, open, setOpenLogInModal }) => {
  ...
  return (
    <motion.div
      ...
      className="fixed w-screen md:w-screen h-screen  drop-shadow-md flex flex-col z-[101] pt-8"
    >
      <Modal modalLable="Log In" onClose={onClose} open={open}>
        <div className="max-w-[700px] mx-auto ">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button className="border border-blue-500 bg-blue-600 hover:bg-white w-full p-4 my- text-white text-xl hover:text-white" onClick={loginWithPopup}>
              {/* Google Sign In */}
              <FcGoogle className="w-full font-bold text-2xl h-15" /> Sign in with your Google Account
            </button>
          </form>
        </div>
      </Modal>
