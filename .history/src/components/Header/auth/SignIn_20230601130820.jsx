      ...
      <Modal modalLable="Log In" onClose={onClose} open={open}>
        <div className="max-w-[700px] mx-auto ">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              className="border border-blue-500 bg-blue-600 hover:bg-white w-full p-4 my- text-textColor text-xl hover:text-white"
              onClick={loginWithPopup}
            >
              {/* Google Sign In */}
              <FcGoogle className="w-full font-bold text-2xl h-15" /> Sign in
