...
export default function Sidenav() {
  return (
    <section className="relative flex h-96 min-h-full items-start justify-center overflow-x-hidden border bg-gray-50 dark:border-zinc-900 dark:bg-zinc-700">
      {/* <!-- Sidenav --> */}
      <nav
        id="sidenav-1"
        className="absolute top-0 left-0 z-[1035] h-full w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
