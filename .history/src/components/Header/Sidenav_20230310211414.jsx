...
const Sidenav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 right-0 w-[105vw] md:w-175 h-flex  bg-white  py-8 px-4  my-20 rounded-lg p-10 pl-5 text-blue-900 fixed backdrop-blur-md drop-shadow-2xl font-bold ease-in-out duration-300 ${
      ...
      >
        <div className="flex items-end pr-40 gap-24 ">
          <Link to={"/"} className="flex items-center gap-2 ">
            <img
              src={logo}
              className="w-[200px] h-[15vh] object-fill right-5"
              alt="logo"
            />
