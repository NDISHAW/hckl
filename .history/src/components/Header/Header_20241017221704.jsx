    ...
    >
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between fill-white">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <Link to={"/"} onClick={() => setShowMenu(!showMenu)} className="dark:text-white text-base text-gray-800 
            focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">
