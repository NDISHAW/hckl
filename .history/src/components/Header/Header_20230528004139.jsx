      ...
      <div className="hidden md:flex w-full h-full items-center justify-between fill-white">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <button
              type="button"
              className="bg-gradient-to-br bg-blue-300 hover:bg-blue-green w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
            >
