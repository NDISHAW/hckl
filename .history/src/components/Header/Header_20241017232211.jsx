    ...
    >
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between fill-white">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <Link to={"/"}>
              <li className="text-lg text-textColor hover:text-h2 hover:text-h2-headingColor hover:font-bold duration-200 transition-all ease-in-out cursor-pointer
              ">
                Home
              </li>
            </Link>
            <Link to={"/about"}>
              <li className="text-lg text-textColor hover:text-headingColor hover:font-bold hover:font-bold duration-100 transition-all ease-in-out cursor-pointer">
                About Us
              </li>
            </Link>
            <Link to={"/products"}>
