        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            <button
              type="button"
              onClick={SignIn}
              className="bg-gradient-to-br bg-blue-300 hover:bg-green-600 w-full md:w-auto px-2 py-0  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
            >
              LOG IN
              <svg
