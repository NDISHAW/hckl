...
const Header = () => {
  ...
  return (
    <header
      ...
      className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-main"
    >
      {/* desktop & tablet */}
      <div className="hidden md:flex w-full h-full items-center justify-between fill-white bg-Main backdrop-blur drop-shadow-lg bg-opacity-100 ">
        {/* Logo */}
