...
const Sidenav = () => {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 right-0 w-[35vw]md:w-175 h-flex  bg-Main  py-8 px-4  my-20 rounded-lg p-10 pl-5 text-textColor fixed backdrop-blur-md font-bold ease-in-out duration-300 ${
