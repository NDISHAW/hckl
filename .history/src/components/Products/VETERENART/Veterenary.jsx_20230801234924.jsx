...
import { labReagents as RLA, veterenary } from "../../../utils/data";
...
export default function Veterenary(flag, data) {
  ...
  return (
    ...
    >
      {/* <div className="w-full h-auto flex flex-col items-center justify-center shadow-lg rounded">veterenary */}
