            ...
            <div class="p-4 lg:max-w-7xl max-w-2xl max-lg:mx-auto">
                <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
                    ...
                    <div class="lg:col-span-2">
                        <h2 class="text-3xl font-semibold text-textcolor">Espresso Elegante | Coffee</h2>
                        ...
                        <div class="flex flex-wrap gap-4 mt-8">
                            <button type="button" class="min-w-[200px] px-4 py-3 bg-blue-300 hover:bg-blue-400 text-black text-sm font-semibold rounded">Buy now</button>
                            <button type="button" class="min-w-[200px] px-4 py-2.5 border border-blue-300 bg-transparent text-textcolor text-sm font-semibold rounded">Add to cart</button>
                        </div>

                        <div class="mt-8">
                            <h3 class="text-xl font-semibold text-textcolor">{About the coffee}</h3>
                        ...
                        <div class="mt-8">
                            <ul class="flex">
                                <li class="text-textcolor font-semibold text-sm bg-transparent py-3 px-8 border-b-2 border-yellow-300 cursor-pointer transition-all">
                                    Reviews</li>
