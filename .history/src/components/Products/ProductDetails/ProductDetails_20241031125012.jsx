...
export default function ProductDetails() {
  ...
  return (
      ...
      <div    className={`w-full flex items-center gap-1  my-1 scroll-smooth  ${
        flag
    ...
    >>
        <div className="lg:px-20 md:px-6 px-4 md:flex items-start">
          <div className="xl:w-96 md:w-80 flex flex-col flex-shrink-0">
            <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/front.png" alt="Image of a shoe" className="w-full" />
