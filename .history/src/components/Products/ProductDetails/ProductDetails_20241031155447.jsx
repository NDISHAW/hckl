                ...
                <div class="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
                    <div class="lg:col-span-3 w-full lg:sticky top-0 text-center">
                        ...
                        <div class="mt-4 flex flex-wrap justify-center gap-4 mx-auto">
                            <div class="w-[90px] h-20 flex items-cemter justify-center bg-o rounded-xl p-4 cursor-pointer">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="mt-8">
                            <ul class="flex">
                                <li class="text-white font-semibold text-sm bg-o py-3 px-8 border-b-2 border-yellow-300 cursor-pointer transition-all">
                                    Reviews</li>
