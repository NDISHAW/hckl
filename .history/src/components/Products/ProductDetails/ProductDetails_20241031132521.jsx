...
import { useParams } from 'react-router-dom';
import data from '../utils/data'; // Import your data source or context

const ProductDetails = () => {
  const { id } = useParams(); // Get item ID from the URL
  const product = data?.find((item) => item.id === id); // Use optional chaining to prevent undefined errors
