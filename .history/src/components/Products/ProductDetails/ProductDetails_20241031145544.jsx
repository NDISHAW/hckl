  ...
  return (
      ...
      >
        <div className="lg:px-20 md:px-6 px-4 md:flex items-start">
          <div className="xl:w-96 md:w-80 flex flex-col flex-shrink-0 w-full">
            <img src={product.imageURL} alt="Product pic" className="w-full" />
          ...
          {/* <div className="xl:ml-32 md:ml-6 md:mt-0 mt-10 lg:max-w-lg md:max-w-sm">
            <h1 className="lg:text-2xl md:text-xl text-lg font-medium lg:leading-6 md:leading-5 leading-5 text-gray-800">{product.title}</h1>
            <p className="text-sm leading-normal text-gray-600 mt-4">{product.calories}</p>
