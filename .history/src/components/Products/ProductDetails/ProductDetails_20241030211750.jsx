      ...
      <div>
        <div className="lg:px-20 md:px-6 px-4 md:flex items-start">
          <div className="xl:w-96 md:w-80 flex flex-col flex-shrink-0">
            <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/shoe-main.png" alt="Image of a shoe" className="w-full" />
          ...
          <div className="xl:ml-32 md:ml-6 md:mt-0 mt-10 lg:max-w-lg md:max-w-sm">
            ...
            <p className="text-sm leading-normal text-gray-600 mt-4">Starting suspicious evaluated should, systems a there would half way. The and the right seemed line have in room. He a be was. To because two hand, palace lieutenant general antiquity pervasively.</p>
            ...
            <div className="lg:flex items-start justify-between mt-12">
              <div className="lg:w-1/2 relative">
                <div onClick={() => setShow(!show)} className="h-10 px-4 border border-gray-600 text-white flex justify-between items-center w-full cursor-pointer">
