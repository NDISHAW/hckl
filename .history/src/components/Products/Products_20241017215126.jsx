    ...
    >
      <section className="w-full ">
        ...
        <div className="w-full">
          {/* Tabs  */}
          <ul
            className="flex mb-0 list-none flex-wrap pt-1 pb-4 flex-row 3list-image-none hover:list-image-[url(NotFound.svg)]"
            role="tablist"
          >
            <li className="-mb-px mr-2 last:mr-0 flex-auto text-center 
            list-image-none hover:list-image-[url(checkmark.png)]">
              <a
                className={
