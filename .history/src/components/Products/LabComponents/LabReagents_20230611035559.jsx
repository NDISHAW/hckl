...
import { labReagents, LRACategories } from "../../../utils/data";
...
const LabReagents = ({ flag, data, scrollValue }) => {
  ...
  const [LRAfilter, setLRAfilter] = useState("LRA_Rhematology");
    ...
    >
      <div className="w-full h-auto flex flex-col items-center justify-center shadow-lg rounded">
          ...
          {labReagents &&
            labReagents.map((category) => (
              <motion.div
                ...
                key={category.id}
                className={`group ${
                  LRAfilter === category.urlParamName
                    ? "bg-blue-400 "
                    : "bg-card"
                ...
                onClick={() => setLRAfilter(category.urlParamName)}
                // onClick={() => setFilter(category.urlParamName)}
              >
                <div
                  className={`w-10 h-10 rounded-full shadow-lg ${
                    LRAfilter === category.urlParamName ? "bg-white" : "bg-Main"
        ...
        {/* <div className="w-full">
          <RowContainer
            flag={false}
            data={LRACategories?.filter((n) => n.category == filter)}
          />
        </div> */}
        {/* <div
          // ref={rowContainer}
        ...
        >
          ...
          {LRACategories && LRACategories.length > 0 ? (
