      ...
      {labEquipment &&
        labEquipment.map((category) => (
          <motion.div
            ...
            key={category.id}
            className={`group ${
              filter.category === category.urlParamName ? "bg-blue-400 " : "bg-card"
            ...
            onClick={() => handleCategoryClick(category.urlParamName, subcategories[0]?.name)}
          >
            <div
              className={`w-10 h-10 rounded-full shadow-lg ${
                filter.category === category.urlParamName ? "bg-white" : "bg-Main"
      ...
      <div className="w-full">
        <RowContainer
          ...
          data={foodItems?.filter(
            (n) =>
              n.category === filter.category && n.subcategory === filter.subcategory
          )}
        />
      </div>
    </div>
