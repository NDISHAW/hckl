...
import {labEquipment} from "../../../../utils/data"
  ...
  return (
    ...
    >
      <div className="w-full h-auto flex flex-col items-center justify-center shadow-lg rounded">
        ...
        <div
          id="labEquipment"
          className="w-full flex items-center justify-start lg:justify-center gap-8 overflow-x-scroll 
          scrollbar-none"
        >
          {labEquipment &&
            labEquipment.map((category) => (
              <motion.div
                ...
                } w-44 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col
                 gap-3 items-center justify-center hover:bg-blue-900 `}
        ...
        {/* <div className="w-full"> */}
          <RowContainer
            flag={false}
            path={`/service-details/${foodItems.id}`}
