...
export default function LabEquipments() {
 ...
 const subcategories = LRACategories.filter(
  ...
  return (
    ...
    >
      <div className="w-full h-auto flex flex-col items-center justify-center shadow-lg rounded"></div>
    <div
      id="hospital"
      ...
      {labReagents &&
        labReagents.map((category) => (
          <motion.div
            ...
            onClick={() =>
              handleCategoryClick(category.urlParamName, subcategories[0]?.name)
            }
          >
            <div
