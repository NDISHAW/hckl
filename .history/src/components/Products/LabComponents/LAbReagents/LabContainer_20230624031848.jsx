  ...
  return (
    ...
    >
      ...
      >
        ...
        {items.length > 0 && (
          <div>
            <table className="mt-3 w-full border border-slate-500">
              <thead className="dark:border-neutral-600">
                <th className="py-2">Lg Class</th>
                <tr className="border border-slate-500">
                  <th className="py-2">Lg Class</th>
                  <th className="py-2 dark:border-neutral-600">Format</th>
                  <th className="py-2 pl-4 dark:border-neutral-600">Cart</th>
                </tr>
              </thead>
              <tbody>
                {items.map((prod) => (
                  <tr key={prod.id} className="border border-slate-500">
                    <td className="py-3 flex-auto dark:border-neutral-600">
                      {prod.lgClass}
                    </td>
