          ...
          <div>
            <table className="mt-3 w-full md:scroll-m-0 ">
              <thead className=" ">
                ...
                <tr className="border ">
                  <th className="py-2 border-neutral-600">Lg Class</th>
                ...
                {items.map((prod) => (
                  <tr key={prod.id} className="border ">
                    ...
                    <td className="py-3 pl-4">
                      <motion.div
                        whileTap={{ scale: 0.75 }}
                        className="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center cursor-pointer hover:shadow-md -mt-2"
