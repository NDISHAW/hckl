    ...
    >
      ...
      >
        <button
          ...
          className="bg-gradient-to-br bg-blue-900 hover:bg-red-600 w-flex md:w-auto px-4 p-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 fixed z-10"
        >
          <MdClose size={30} />{" "}
        </button>
        {isClicked.map((prod) => (        
