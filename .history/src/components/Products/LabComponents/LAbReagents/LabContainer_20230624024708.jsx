...
const LabContainer = ({ flag, data, scrollValue }) => {
  ...
  <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style={} title="Woman holding a mug">
  </div>
