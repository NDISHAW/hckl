...
//                 onClick={() => addToCart({ ...labReagent.data })}
//               >
...
//             {detail.map((item) => (
//               <div className="w-full flex flex-col items-center justify-center">
//                 {/* <p className="font-bold text-blue-600 mt-6">Description</p> */}
//                 {/* <p className="text-textColor mt-3">{item.data}</p> */}
...
//                <tbody>
//                  <tr>
//                    <td className="py-3 flex-auto">{item.lgClass}</td>
//                    <td className="py-3 flex-auto">{item.Format}</td>
...
const [items, setItems] = useState([]);
  ...
  return (
    <div
      ...
      // className={`w-full flex flex-col items-center justify-cente gap-8 my-1 scroll-smooth ${
      //   flag
      //     ? "overflow-x-scroll scrollbar-none"
      //     : "overflow-x-hidden flex-wrap justify-center"
      // }`}
