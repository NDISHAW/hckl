...
const LabContainer = ({ flag, data, scrollValue }) => {
  ...
  const addtoCart = (detail) => {
    dispatch({
      ...
      cartItems: [...cartItems, detail],
    });
    localStorage.setItem(
      "cartItems",
      JSON.stringify([...cartItems, detail])
    );
  };
  ...
  return (
    ...
    >
          ...
          >
            <div className="w-full flex h-fit items-center justify-between">
              <div className="w-full flex flex-col items-end justify-end -mt-8">
                <p>Method: {labReagent.data.Method}</p>
                <h3>Category: {labReagent?.data.category}</h3>
      ...
      <Modal onClose={() => setIsOpen(false)} open={isOpen} style={customStyles}>
        <button
            ...
            <table className="mt-3 w-full">
              ...
              <tbody>
                {selectedProduct.details.map((detail) => (
                  <tr key={detail.id}>
                    <td className="py-3 flex-auto">{detail.lgClass}</td>
                    <td className="py-3 flex-auto">{detail.Format}</td>
...
//             </div>
//             {/* <div class="p-6">
//               <h5 class="mb-2 text-xl font-medium leading-tight text-textColor ">
//                 {labReagent?.data.Parameter}
//               </h5>
//               <p class="mb-4 text-base text-textColor">
