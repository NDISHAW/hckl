    ...
    >
      ...
      >
        <button
          ...
          className="bg-gradient-to-br bg-blue-900 hover:bg-red-600 w-flex md:w-auto px-4 pb-8  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 fixed z-10"
        >
          <MdClose size={30} />{" "}
        </button>
        {isClicked.map((prod) => (        
              ...
              <table className="mt-1 w-full">
                ...
                <tbody>
                  <tr>
                    ...
                    {/* <td className="py-2">Data 3</td> */}
                  </tr>
                  {/* <tr>
                    <td className="py-2">Data 4</td>
                    <td className="py-2">Data 5</td>
                    <td className="py-2">Data 6</td>
                  </tr> */}
                </tbody>
              </table>
              {/* <div className="w-[575px] h-[575px] min-w-[275px] md:w-300 md:min-w-[300px] bg-cardOverlay rounded-lg py-2 px-4 my- backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative">
                <div className="w-full flex h-fit items-center justify-between">
                  <motion.div
