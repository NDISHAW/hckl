  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <button
          type="button"
          className="bg-gradient-to-br from-blue-100 to-blue-900 w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg-bl transition-all ease-in-out duration-100"
        >
