  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1">
        ...
        <button
          className="bg-gradient-to-br bg-red-300 hover:bg-red-600 w-auto md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 justify-items-center"
