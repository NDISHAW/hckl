              ...
              {vete && vete.length > 0 ? (
                vete.map((task) => (
                  <Veterenary
                    id={task.id}
                    key={task.id}
                    Method={task.dataMethod}
                    SubCartegory={task.dataSubCartegory}
                    OrderNumber={task.dataOrderNumber}
                    Substrate={task.dataSubstrate}
                    DiagnosticApplication={task.dataDiagnosticApplication}
                    category={task.datacategory}
                    // subcollectionData={task.data.subcollectionData}
                    // category={task.data.category}
                  />
                ))
