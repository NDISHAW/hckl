...
import { MdCloudUpload,MdSave, MdDelete, MdAttachMoney } from "react-icons/md"; <MdSave size={20} color="#fff" />;
        ...
        >
          ...
          <div>
            {/* <span className="text-xl text-blue-500"> */}
              <button
                type="submit"
                className="bg-gradient-to-br bg-green-600 hover:bg-green-400 w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
                // onClick={saveDetails}
              >
                Save
              </button>
