              ...
              {vete && vete.length > 0 ? (
                vete.map((vet) => (
                  <Veterenary
                    ...
                    SubCartegory={vet.dataSubCartegory}
                    OrderNumber={vet.dataOrderNumber}
                    Substrate={vet.dataSubstrate}
                    DiagnosticApplication={vet.dataDiagnosticApplication}
                    category={vet.datacategory}
                    // subcollectionData={task.data.subcollectionData}
                    // category={task.data.category}
                  />
                ))
