...
import "../addTask.css";
import { doc, updateDoc, collection, getDoc,deleteDoc,addDoc } from "firebase/firestore";
...
function EditVeterenary({
  ...
  const [OrderNumber, setOrderNumber] = useState(toEditOrderNumber);
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    const vetDocRef = getDoc(firestore, "Vet", id);
    try {
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 w-auto my-14 backdrop-blur drop-shadow-lg bg-opacity-500">
          <div>
            ...
            <div className="w-full">
              ...
              <span value={id} className="text-xl text-blue-500">Substrate</span>  <br></br>
            </div>
            {/* Short Substrate */}
            <p className="text-textColor font-semibold text-base md:text-lg m-2">
