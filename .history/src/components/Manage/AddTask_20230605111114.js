      ...
      <form onSubmit={handleSubmit} className="addTask" name="addTask">
        ...
        >
          ...
          <div>
            ...
            <textarea
              className="block p-2.5 w-flex text-sm text-textColor-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              cols="40"
              rows="13"
