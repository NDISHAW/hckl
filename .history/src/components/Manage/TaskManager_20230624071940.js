              ...
              {tasks && tasks.length > 0 ? (
                tasks.map((task) => (
                  <LRA
                    id={task.id}
                    key={task.id}
                    title={task.data.<div className="taskManager__container">
            <div className="grid">
              {tasks && tasks.length > 0 ? (       
                tasks.map((task) => (                  
                  <Task
                ...
                <div className="w-full flex flex-col items-center justify-center">
                  <p className="text-xl text-headingColor font-semibold my-2">
                    ...
                    calories={task.data.<div className="taskManager__container">
            <div className="grid">
              {tasks && tasks.length > 0 ? (       
                tasks.map((task) => (                  
                  <Task
                ...
                <div className="w-full flex flex-col items-center justify-center">
                  <p className="text-xl text-headingColor font-semibold my-2">
                    ...
                    description={task.data.<div className="taskManager__container">
            <div className="grid">
              {tasks && tasks.length > 0 ? (       
                tasks.map((task) => (                  
                  <Task
                ...
                <div className="w-full flex flex-col items-center justify-center">
                  <p className="text-xl text-headingColor font-semibold my-2">
                    ...
                    category={task.data.<div className="taskManager__container">
            <div className="grid">
              {tasks && tasks.length > 0 ? (       
                tasks.map((task) => (                  
                  <Task
                ...
                <div className="w-full flex flex-col items-center justify-center">
                  <p className="text-xl text-headingColor font-semibold my-2">
                    ...
                    price={task.data.<div className="taskManager__container">
            <div className="grid">
              {tasks && tasks.length > 0 ? (       
                tasks.map((task) => (                  
                  <Task
                ...
                <div className="w-full flex flex-col items-center justify-center">
                  <p className="text-xl text-headingColor font-semibold my-2">
                    ...
                    imageURL={task.data.<div className="taskManager__container">
            <div className="grid">
              {tasks && tasks.length > 0 ? (       
                tasks.map((task) => (                  
                  <Task
