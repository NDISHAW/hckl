...
function Task({id, imageURL, title, calories, price, completed,description }) {
  ...
  return (
    <>
        ...
        <div>
          ...
          >
            <img
              ...
              variant="gradient"
            />
           <div> <p className="text-textColor font-semibold text-base md:text-lg">
              {title}
            </p></div>
          </motion.div>
        </div>
      ...
      <div
        // ref={rowContainer}
        className={`grid grid-cols-2 grid-flow-col w-screen  items-center gap-3  my-12 scroll-smooth  }`}
        data-aos="fade-up"
      ...
      >
        <div className="w-auto h-[375px] min-w-[auto] md:w-flex md:min-w-[flex]  bg-cardOverlay rounded-lg py-2 px-4  my-12 backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative">
          <div className="grid grid-cols-2 w-full  h-fit items-center justify-between">
            <motion.div
