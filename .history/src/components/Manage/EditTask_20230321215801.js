...
function EditTask({open, onClose, toEditTitle, toEditDescription,toEditCategory,toEditCalories,toEditPrice, id}) {
  ...
  const [imageAsset, setImageAsset] = useState(toEditIimageAsset);
