          ...
          <div className="taskManager__container">
            <div className="grid">
              {labEquipment && labEquipment.length > 0 ? (
                labEquipment.map((labEquipment) => (
                  <Task
                    id={labEquipment.id}
                    key={labEquipment.id}
                    title={labEquipment.data.title}
                    calories={labEquipment.data.calories}
                    description={labEquipment.data.description}
                    category={labEquipment.data.category}
                    price={labEquipment.data.price}
                    imageURL={labEquipment.data.imageURL}
