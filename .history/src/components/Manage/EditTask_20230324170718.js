  ...
  return (
    <Modal modalLable="Edit Product" onClose={onClose} open={open}>
      <form
        ...
        className="grid grid-cols gap-4 w-auto my-14"
        // name="addTask"
      >
        {fields && (
          <motion.p
        ...
        >
          ...
          <div>
            ...
            <button
              type="submit"
              className="bg-gradient-to-br bg-green-600 hover:bg-blue-400 w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100 text-white hover:text-green-900"
              // onClick={saveDetails}
            >
              <MdSave size={60} /> Save
            </button>
