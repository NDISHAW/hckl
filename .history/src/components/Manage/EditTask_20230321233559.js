        ...
        >
          ...
          <div>
            {/* <span className="text-xl text-blue-500"> */}
              <button
                type="submit"
                className="bg-gradient-to-br bg-blue-300 hover:bg-green-900 w-full md:w-auto px-4 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
                // onClick={saveDetails}
              >
                Done
              </button>
