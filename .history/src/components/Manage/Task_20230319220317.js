...
function Task({id, imageURL, title, calories, price, completed }) {
  ...
  return (
    <div className={`task `}>
      ...
      >
        <div
          className="w-full h-[375px] min-w-[275px] md:w-300 md:min-w-[300px]  bg-cardOverlay rounded-lg py-2 px-4  my-12 backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-evenly relative"
        >
