...
function AddEditLra({
  ...
  }, [editIndex, toEditTitle, toEditDescription, toEditSubCartegory, toEditCalories, toEditPrice, toEditImageAsset, toEditCategory, toEditsubcollectionData]);
  ...
  return (
    <Modal modalLable={editIndex !== -1 ? "Edit Product" : "Add Product"} onClose={onClose} open={open}>
      <form onSubmit={editIndex !== -1 ? handleUpdate : handleSubmit} name="addTask">
        {fields && (
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
