                  ...
                  <table>
                    ...
                    {subcollectionData.map((detailItem) => (
                      <tbody className="text-xl px-4">
                        <tr>
                          <td key={detailItem.subcollectionData.id}>
                            <input
                              type="text"
                              required
                              value={detailItem.subcollectionData.lgClass}
                              onChange={(e) => setFormat(e.target.value)}
                              placeholder="Format"
                              className="w-flex h-full text-lg bg-transparent outline-none border-none placeholder:text-gray-400 text-textColor"
                            />
                          </td>
                          <td key={detailItem.subcollectionData.id}>{detailItem.subcollectionData.Format}</td>
                        </tr>
                      </tbody>
                    ))}
                  </table>
