                        ...
                        <tr key={index}>
                          <td>
                            <input
                              ...
                              placeholder="lgClass"
                              className="w-[10px] h-[30px] text-xl bg-transparent outline-none border-none placeholder:text-gray-400 text-textColor"
                            />
                          </td>
                          <td>
                            <input
                              ...
                              placeholder="Format"
                              className="w-[10px] h-[30px] text-xl bg-transparent outline-none border-textColor placeholder:text-gray-400 text-textColor"
                            />
                          </td>
                          <td>
                            <button
