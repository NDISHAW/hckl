...
const ReagentComponent = () => {
  ...
  const reagentsCollectionRef = firestore.collection('reagents');
  ...
  const fetchReagents = async () => {
    try {
      const snapshot = await reagentsCollectionRef.get();
  ...
  const addReagent = async () => {
    try {
      const docRef = await reagentsCollectionRef.add(newReagent);
      setNewReagent({
        method: '',
        parameter: '',
        species: '',
  ...
  const updateReagent = async (id, updatedReagent) => {
    try {
      await reagentsCollectionRef.doc(id).update(updatedReagent);
  ...
  const deleteReagent = async (id) => {
    try {
      await reagentsCollectionRef.doc(id).delete();
    ...
    <div>
      ...
      <ul>
        {reagents.map((reagent) => (
          <li key={reagent.id}>
            ...
            <button onClick={() => updateReagent(reagent.id, { method: 'New Method' })}>
              Update
            </button>
      ...
      <label>
        ...
        <input
          ...
          onChange={(e) => setNewReagent({ ...newReagent, method: e.target.value })}
        />
      </label>
      <label>
        Parameter:
        <input
          ...
          onChange={(e) => setNewReagent({ ...newReagent, parameter: e.target.value })}
        />
      </label>
      <label>
        Species:
        <input
          ...
          onChange={(e) => setNewReagent({ ...newReagent, species: e.target.value })}
        />
      </label>
      <label>
        Substrate:
        <input
          ...
          onChange={(e) => setNewReagent({ ...newReagent, substrate: e.target.value })}
        />
      </label>
      <label>
        Nested Object:
        <input
          ...
          onChange={(e) =>
            setNewReagent({
              ...newReagent,
              nestedObject: { ...newReagent.nestedObject, lgClass: e.target.value }
            })
          }
        />
      </label>
      <label>
        ...
        <input
          ...
          onChange={(e) =>
            setNewReagent({
              ...newReagent,
              nestedObject: { ...newReagent.nestedObject, Format: e.target.value }
            })
          }
        />
      </label>
