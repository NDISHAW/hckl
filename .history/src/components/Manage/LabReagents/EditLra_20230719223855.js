...
import "../addTask.css";
import { doc, updateDoc, collection, getDocs,deleteDoc
...
function EditLra({
  ...
  const handleUpdate = async (e) => {
    ...
    const subcollectionRef = collection(taskDocRef, "details"); // Replace "subcollectionName" with the actual name of the subcollection
