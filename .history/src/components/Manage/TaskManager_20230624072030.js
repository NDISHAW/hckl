              ...
              {tasks && tasks.length > 0 ? (
                tasks.map((task) => (
                  <LRA
                    id={task.id}
                    key={task.id}
                    title={task.data.Method}
                    calories={task.data.SubCartegory}
                    description={task.data.Parameter}
                    category={task.data.Substrate}
                    price={task.data.Species}
                    imageURL={task.data.category}
                    // price={task.data.price}
                    // category={task.data.category}
                  />
                ))
