...
const Contact = ({ onClose, open }) => {
  ...
  return (
    <Modal modalLable="Contact Us" onClose={onClose} open={open}>
      ...
      className="fixed w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]"
    >
      <section className="bg-Main text-textColor justify-center" id="contact">
        <Toaster />
