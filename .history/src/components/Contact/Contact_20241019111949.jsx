...
const Contact = ({ onClose, open }) => {
  ...
  return (
    <div
      className="w-auto h-fit flex flex-col bg-primary my-"
                        ...
                        <div className="block xl:flex w-full flex-wrap justify-between mb-6">
                            <div className="w-2/4 max-w-xs mb-6 xl:mb-0">
                                <div className="flex flex-col">
                                    ...
                                    <input required id="full_name" name="from_name" type="text" required
                            ...
                            <div className="w-2/4 max-w-xs">
                                <div className="flex flex-col">
                                    ...
                                    <input required id="email" name="user_email" type="email" required
                                    className="focus:outline-none focus:border focus:border-indigo-700 font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" placeholder />
                                </div>
                            </div>
                        </div>
