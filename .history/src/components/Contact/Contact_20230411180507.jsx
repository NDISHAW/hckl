      ...
      >
        ...
        >
          ...
          <div className="md:container px-5 py-14">
            ...
            <h1 className="title !text-textColor font-extrabold text-2xl">
              <Typical
                loop={Infinity}
                steps={[
            ...
            <div className="flex gap-10 md:flex-row flex-col">
              ...
              >
                ...
                <motion.button
                  whileTap={{ scale: 3.8 }}
                  type="button"
                  className="w-40 p-2 rounded-full bg-gradient-to-tr from-blue-200 to-blue-900 text-gray-50 text-lg my-2 hover:shadow-lg hover:text-textColor"
                >
