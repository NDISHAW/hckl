            ...
            <div className="flex gap-10 md:flex-row flex-col">
              ...
              >
                ...
                <motion.button
                  whileTap={{ scale: 3.8 }}
                  type="button"
                  className="w-auto p-2 rounded-full bg-gradient-to-tr from-blue-200 to-blue-900 text-gray-50 text-lg my-2 hover:shadow-lg hover:text-textColor"
                >
                  <h4 className="text-textColor"></h4>Send {createElement(GrMail)}
                </motion.button>
              </form>
