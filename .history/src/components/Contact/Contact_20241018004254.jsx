        ...
        <div className=" flex justify-center lg:justify-end px-4">
          <div className="bg-white shadow rounded-lg p-8 sm:p-12 w-full">
            ...
            <div className="mt-4 sm:mt-16 flex flex-col w-full space-y-10">
              ...
              afocus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 hover:bg-indigo-600">Send Message</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto flex flex-col space-y-6 lg:space-y-0 lg:flex-row justify-between">
          <div className="flex space-x-6 flex-row lg:space-x-0 sm:items-start justify-between lg:justify-center">
            <div className="pr-4">
              ...
              <p className="text-xs sm:text-base leading-normal text-white sm:mt-4 lg:w-1/2">Buruburu shopping Centre Ngemwa House 2nd floor Office No. 23.</p>
              <p className="text-xs sm:text-base leading-normal text-white sm:mt-4 lg:w-1/2">P.O BOX 11038-00100 Nairobi Kenya</p>
            </div>
            <div className>
