...
const Contact = ({ onClose, open }) => {
  ...
  return (
    <motion.div
        ...
        className="fixed w-screen md:w-screen h-screen bg-Main drop-shadow-md flex flex-col z-[101]"
      >
    <Modal
      modalLable="Contact Us"
      onClose={onClose}
      open={open}
      className="fixed w-[160vw] md:w-375 h-screen bg-Main drop-shadow-md flex flex-col z-[101]"
    >
      
        <section className=" text-textColor justify-center" id="contact">
          <Toaster />
          <div className="md:container px-5 py-14">
            ...
            <div className="flex gap-10 md:flex-row flex-col">
              <form
                ...
                onSubmit={sendEmail}
                data-aos="fade-up"
                className="flex-1 flex flex-col gap-5 bg-Main"
              >
            ...
            bg-Main text-dark_primary border-slate-600"
                >
                  Submit
                </button>
              </form>
