            ...
            <div className="flex gap-10 md:flex-row flex-col">
              ...
              >
                ...
                <motion.button
                  whileTap={{ scale: 0.8 }}
                  type="button"
                  className="w-flex p-2 rounded-full bg-gradient-to-tr from-blue-400 to-blue-900 text-gray-50 text-lg my-2 hover:shadow-lg hover:text-textColor"
                >
                  <button
                    className="btn self-start
             text-dark_primary border-slate-600"
                  >
                    Submit
                  </button>
                </motion.button>
