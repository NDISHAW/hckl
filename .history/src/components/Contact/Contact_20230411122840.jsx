          ...
          <div className="md:container px-5 py-14">
            ...
            <div className="flex gap-10 md:flex-row flex-col">
              ...
              >
                ...
                whileTap={{ scale: 0.8 }}
                type="button"
                className="w-full p-2 rounded-full bg-gradient-to-tr from-blue-400 to-blue-900 text-gray-50 text-lg my-2 hover:shadow-lg 
                <button
                  className="btn self-start font-semibold hover:bg-green-300
            bg-white text-dark_primary border-slate-600"
                >
                  Submit
                </button>
              </form>
