  ...
  return (
    ...
    <div className="relative h-full">
      ...
      <iframe id="iframe" className=" w-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.810762689687!2d36.87861611461446!3d-1.2876717359905419!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f13efb0a813ef%3A0x67fd419680769624!2sHospital%20Consumables!5e0!3m2!1sen!2ske!4v1678474322205!5m2!1sen!2ske"
       width={425} height={250} style={{ border: 0, height: 500 }} allowFullScreen title="maps" />
      ...
      <div className="w-full relative z-20 bg-blue-400 pt-20 pb-8 md:pt-16 md:pb-8 px-4" style="background-image: url(https://i.ibb.co/8sk93vs/Group-216-1.png)">
        <img src="https://i.ibb.co/8sk93vs/Group-216-1.png" alt="Background image" class=""style="background-image: url(...)" />
