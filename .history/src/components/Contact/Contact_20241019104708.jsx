...
const Contact = ({ onClose, open }) => {
  ...
  return (
    <div
      className="w-auto h-screen flex flex-col bg-primary my-"
      data-aos="fade-right"
      data-aos-duration="3000"
    ><p className="text-xl font-bold capitalize text-Main relative before:absolute before:rounded-lg
 ...
 CONTACT US
            ...
            <div className="xl:flex lg:flex pt-14">
                ...
                <div className="xl:w-2/5 lg:w-2/5 py-16 flex items-center">
                    <div className="w-5/6 mx-auto">
                        ...
                        <iframe
                            ...
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d429154.75848513725!2d-117.38916630193054!3d32.824817514402476!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d9530fad921e4b%3A0xd3a21fdfd15df79!2sSan%20Diego%2C%20CA%2C%20USA!5e0!3m2!1sen!2s!4v1593793817578!5m2!1sen!2s"
                            width={425}
                            height={250}
                            style={{
                                border: 0,
