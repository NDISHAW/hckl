      ...
      >
        ...
        >
          ...
          <div className="md:container px-5 py-14">
            ...
            <h1 className="title !text-textColor font-bold text-2xl">
              <Typical
                loop={Infinity}
                steps={[
                  " Feel free to send us an email and we will get in touch. ",
                  800,
            ...
            <div className="flex gap-10 md:flex-row flex-col">
              ...
              >
                ...
                <motion.button
                  ...
                  type="button"
                  onClick={submit}
                  className="w-40 p-2 rounded-full bg-gradient-to-tr from-blue-200 to-blue-900 text-gray-50 text-lg my-2 hover:shadow-lg hover:text-textColor btn self-start"
                >
                  <h1 className="font-bold">SEND {createElement(GrMail)}</h1>
                </motion.button>
              </form>
