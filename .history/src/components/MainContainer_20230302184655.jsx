...
import { categories, labReagents } from "../utils/data";
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <div
          id="hospital"
          className={'w-full flex items-center justify-start lg:justify-center gap-8 py-6 overflow-x-scroll scrollbar-none badgesList ${labEqupmentClassName}1}
        >
          className={`badgesList  ${labEqupmentClassName}`}
          {labReagents &&
