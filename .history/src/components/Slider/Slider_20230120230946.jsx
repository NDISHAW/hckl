...
export default function Slider() {
  ...
  return (
    <div
      ref={slideRef}
      className="max-w-screen-xl m-auto relative h-90vh md:flex-auto"
    >
      ...
      <div className="absolute w-full top-1/2 transform -translate-y-1/2 px-3 flex justify-between items-center md:flex-auto">
        ...
        <button
          className=" bg-black text-white p-1 rounded-full bg-opacity-50 cursor-pointer hover:bg-opacity-100 transition md:flex-auto"
