...
import { MdOutlineKeyboardBackspace, MdLogin } from "react-icons/md";
    ...
    <>
      ...
      >
        <div className="w-full flex items-center justify-between p-4 cursor-pointer">
          ...
          {user ? (
            <motion.button
              ...
              onClick={sendEmail}
            >
              {/* CartItems send to email container */}
              <form ref={form}>
                <input type="hidden" name="to_email" value={user.email}></input>
        ...
        {cartItems && cartItems.length > 0 ? (
          <div className="w-full h-flex bg-cartBg rounded-t-[2rem] flex flex-col">
            {/* cart Items section */}
            <div className="w-full h-auto md:h-42 px-6 py-10  pb-6 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
              {/* cart Item */}
              {cartItems &&
                cartItems.length > 0 &&
                cartItems.map((item) => (
