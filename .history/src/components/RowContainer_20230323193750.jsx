                ...
                return (
                  <>
                    <button
                      ...
                      className="bg-gradient-to-br bg-blue-900 hover:bg-red-600 w-flex md:w-auto px-1 py-2  rounded-lg hover:shadow-lg transition-all ease-in-out duration-100"
                    >
                      X
                    </button>
                    <div
