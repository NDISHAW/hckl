    ...
    >
      ...
      {cartItems && cartItems.length > 0 ? (
        <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
          ...
          {/* cart total section */}
          <div className="fixed bottom-0 right-0 w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-12 h-auto hover:bg-green-600">
