...
const data = [
  {
    ...
    colorLite: "#FFFFFF",
    mainText: "Microscopes",
    subText: "Explore the world with precision microscopes.",
    shadow: "0px 10px 20px rgba(78, 112, 149, 0.8)",
    mobileShadow: "0px 5px 20px rgba(78, 112, 149, 0.8)",
    img: "microscopes.jpg",
    buttonStyle: { top: "70%", left: "10%" }, // Custom button position
  },
  {
    id: 2,
    colorDeep: "#B60313",
    colorLite: "#FFFFFF",
    mainText: "Eldon",
    subText: "Transform Your Skin with Promoil's Argan Oil.",
    shadow: "0px 10px 20px rgba(130, 134, 99, 0.8)",
    mobileShadow: "0px 5px 20px rgba(130, 134, 99, 0.8)",
    img: "eldon.jpeg",
    buttonStyle: { top: "60%", right: "15%" }, // Custom button position
  },
  {
    id: 3,
    colorDeep: "#431e1e",
    colorLite: "#FFFFFF",
    mainText: "Medcon",
    subText: "Discover the best in medical equipment.",
    shadow: "0px 10px 20px rgba(67, 30, 30, 0.8)",
    mobileShadow: "0px 5px 20px rgba(67, 30, 30, 0.8)",
    img: "medcon.jpeg",
    buttonStyle: { bottom: "20%", left: "50%", transform: "translateX(-50%)" }, // Centered button
  },
];
    ...
    >
      {data.map(({ id, colorDeep, mainText, subText, shadow, mobileShadow, img, buttonStyle }) => (
        <SwiperSlide
          ...
          className="w-full h-screen flex flex-col gap-10"
        >
          <Hero
            colorDeep={colorDeep}
            mainText={mainText}
