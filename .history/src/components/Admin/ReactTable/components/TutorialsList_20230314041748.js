  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: (tableProps) => (
          <div>
            <img className="rounded-full h-8 md:mr-4 border-2 border-white shadow-sm" alt="prod img" src={tableProps.row.original.imageURL} />
            {tableProps.row.original.imageURL}
          </div>
        ),
      },
      {
