...
import centrifuge from "../img/centrifuge";
...
const Hero = ({colorDeep, mainText, shadow, mobileShadow, subText, img}) => {
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 lg:px-16 z-10 bg-opacity-60 bg-black">
