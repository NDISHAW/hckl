...
const HomeContainer = () => {
  return (
    <section
      className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full bg-transparent md:mb-10"
      id="home "
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
          Hospital Consumables Kenya Limited (HCKL) is a wholly owned Kenyan company.
