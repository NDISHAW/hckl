...
const HomeContainer = () => {
  return (
    <section
      className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full bg-transparent "
      id="home"
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        <div className="flex items-center gap-2 justify-center bg-Main-100 px-4 py-1 rounded-full bg-transparent">
          <p className="text-base text-blue-400 font-bold text-[2rem] lg:text-[4rem] text-[2rem] lg:text-[4rem]  ">ABOUT US</p>
