  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <div
          id="ListSport"
          className={`w-full flex items-center justify-start lg:justify-center gap-8 py-6 overflow-x-scroll scrollbar-none badgesList ${labReagelabEqupmentClassNamentsClassName}`}
        >
          {labReagents &&
