...
export const categories = [
  ...
  },
  {
    ...
    name: "Laborotary Products",
    urlParamName: "lab",
    subCartegories:Equipment: ["Hematology","Clinichal Chemistry", "Molecular Diagnostics", "Immmuno Florecent (IFA)", "ELISA","Chemiluminecents","Immmunoblots",""],
    Reagents: ["Rhematology","Hepatology", "Gastroenterology", "Endocrionology", "Neurology","Nephrology","Dermatology","ClinicalChemistry","Hematology","Cytology","Molecular"],
  },
  {
    id: 3,
    name: "Microscopes",
